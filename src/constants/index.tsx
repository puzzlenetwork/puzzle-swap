...
export const POOL_CONFIG: IPoolConfig[] = [
  {
    ...
    tokens: [
      { ...tokens.WAVES, share: 0.25, logo: tokenLogos.WAVES },
      { ...tokens.BTC, share: 0.25, logo: tokenLogos.BTC },
      { ...tokens.ETH, share: 0.25, logo: tokenLogos.ETH },
      { ...tokens.USDN, share: 0.25, logo: tokenLogos.USDN },
    ],
  },
  {
    domain: "nsbt",
    ...
    tokens: [
      { ...tokens.SNSBT, share: 0.75, logo: tokenLogos.SNSBT },
      { ...tokens.NSBT, share: 0.2, logo: tokenLogos.NSBT },
      { ...tokens.USDN, share: 0.05, logo: tokenLogos.USDN },
    ],
  },
  {
    domain: "www",
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.WX, share: 0.6, logo: tokenLogos.WX },
      { ...tokens.WCT, share: 0.1, logo: tokenLogos.WCT },
      { ...tokens.WEST, share: 0.1, logo: tokenLogos.WEST },
      { ...tokens.USDN, share: 0.2, logo: tokenLogos.USDN },
    ],
  },
  {
    domain: "sheg",
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.SHEG, share: 0.5, logo: tokenLogos.SHEG },
      { ...tokens.USDN, share: 0.25, logo: tokenLogos.USDN },
      { ...tokens.WAVES, share: 0.13, logo: tokenLogos.WAVES },
      { ...tokens.EGG, share: 0.12, logo: tokenLogos.EGG },
    ],
  },
  {
    domain: "muna",
    ...
    tokens: [
      { ...tokens.MUNA, share: 0.5, logo: tokenLogos.MUNA },
      { ...tokens.BNB, share: 0.25, logo: tokenLogos.BNB },
      { ...tokens.USDN, share: 0.25, logo: tokenLogos.USDN },
    ],
  },
  {
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.USDC, share: 0.3, logo: tokenLogos.USDC },
      { ...tokens.USDT, share: 0.1, logo: tokenLogos.USDT },
      { ...tokens.USDN, share: 0.2, logo: tokenLogos.USDN },
      { ...tokens.PUZZLE, share: 0.22, logo: tokenLogos.PUZZLE },
      { ...tokens.VIRES, share: 0.08, logo: tokenLogos.VIRES },
      { ...tokens.EURN, share: 0.1, logo: tokenLogos.EURN },
    ],
  },
  {
    domain: "defi",
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.WAVES, share: 0.2, logo: tokenLogos.WAVES },
      { ...tokens.EGG, share: 0.1, logo: tokenLogos.EGG },
      { ...tokens.SWOP, share: 0.05, logo: tokenLogos.SWOP },
      { ...tokens.VIRES, share: 0.05, logo: tokenLogos.VIRES },
      { ...tokens.NSBT, share: 0.05, logo: tokenLogos.NSBT },
      { ...tokens.ENNO, share: 0.05, logo: tokenLogos.ENNO },
      { ...tokens.SIGN, share: 0.05, logo: tokenLogos.SIGN },
      { ...tokens.PUZZLE, share: 0.2, logo: tokenLogos.PUZZLE },
      { ...tokens.USDT, share: 0.1, logo: tokenLogos.USDT },
      { ...tokens.USDN, share: 0.15, logo: tokenLogos.USDN },
    ],
  },
  {
    domain: "defi",
  ...
  },
  {
    ...
    tokens: [
      ...
      { ...tokens.MATH, share: 0.1, logo: tokenLogos.MATH },
      { ...tokens.TURTLE, share: 0.1, logo: tokenLogos.TURTLE },
      {
        ...tokens.EGGSEGGS,
        share: 0.1,
      ...
      { ...tokens.FOMO, share: 0.1, logo: tokenLogos.FOMO },
      { ...tokens.MUNDO, share: 0.1, logo: tokenLogos.MUNDO },
      {
        ...tokens.EGGPOINT,
        share: 0.1,
      ...
      { ...tokens.EGG, share: 0.1, logo: tokenLogos.EGG },
      { ...tokens.USDN, share: 0.1, logo: tokenLogos.USDN },
    ],
  },
  {
    domain: "farms2",
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.ENDO, share: 0.1, logo: tokenLogos.ENDO },
      { ...tokens.MARVIN, share: 0.1, logo: tokenLogos.MARVIN },
      { ...tokens.EGGMOON, share: 0.1, logo: tokenLogos.EGGMOON },
      { ...tokens.STREET, share: 0.1, logo: tokenLogos.STREET },
      { ...tokens.KOLKHOZ, share: 0.1, logo: tokenLogos.KOLKHOZ },
      { ...tokens.FORKLOG, share: 0.1, logo: tokenLogos.FORKLOG },
      { ...tokens.CGU, share: 0.1, logo: tokenLogos.CGU },
      { ...tokens.EGG, share: 0.2, logo: tokenLogos.EGG },
      { ...tokens.USDN, share: 0.1, logo: tokenLogos.USDN },
    ],
  },
  {
    ...
    defaultAssetId1: tokens.USDN.assetId,
    tokens: [
      { ...tokens.EGG, share: 0.4, logo: tokenLogos.EGG },
      { ...tokens.RACE, share: 0.4, logo: tokenLogos.RACE },
      { ...tokens.USDN, share: 0.2, logo: tokenLogos.USDN },
    ],
  },
  {
    ...
    tokens: [
      { ...tokens.EGG, share: 0.8, logo: tokenLogos.EGG },
      { ...tokens.USDN, share: 0.2, logo: tokenLogos.USDN },
    ],
  },
  {
    ...
    tokens: [
      { ...tokens.USDT, share: 0.1, logo: tokenLogos.USDT },
      { ...tokens.PUZZLE, share: 0.8, logo: tokenLogos.PUZZLE },
      { ...tokens.USDN, share: 0.1, logo: tokenLogos.USDN },
    ],
  },
];
...
export interface IPoolConfig {
  ...
  tokens: Array<IToken & { share: number } & { claimReward?: string }>;
