...
export const POOL_CONFIG: IPoolConfig[] = [
  ...
  },
  {
    ...
    baseTokenId: TOKENS_BY_SYMBOL.WBTC_WXG.assetId,
    title: "Pool 10",
    logo: tokenLogos.WBTC_WXG,
    defaultAssetId0: TOKENS_BY_SYMBOL.WBTC_WXG.assetId,
    defaultAssetId1: TOKENS_BY_SYMBOL.XTN.assetId,
    tokens: [
      { ...TOKENS_BY_SYMBOL.WAVES, share: 25, logo: tokenLogos.WAVES },
      { ...TOKENS_BY_SYMBOL.WBTC_WXG, share: 25, logo: tokenLogos.WBTC_WXG },
  ...
  },
  {
    ...
    defaultAssetId1: TOKENS_BY_SYMBOL.XTN.assetId,
    tokens: [
      { ...TOKENS_BY_SYMBOL.USDC_WXG, share: 30, logo: tokenLogos.USDC_WXG },
...
export const CONTRACT_ADDRESSES = {
  ...
  priceOracle: "3P8pvmcBi9JeBrnPgWDTaPWrWmGzxiDkpTu",
};
